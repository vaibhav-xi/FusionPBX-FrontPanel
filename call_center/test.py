...
command_str = "{origination_caller_id_number=123456789,origination_caller_id_name=Admin}sofia/internal/" + num_extension + "%167.99.241.212"
...
def main():
    ...
    try:
        ...
        #  context="'&socket(167.99.241.212:8888 async full)'")

        result = yield client.make_call(
            ext=command_str,
            context="&playback(/usr/share/freeswitch/sounds/music/default/8000/onedance.wav)")
        print "RESULTS:"
        print result
